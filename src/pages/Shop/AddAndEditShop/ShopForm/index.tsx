...
const ShopForm = (props: any) => {
  ...
  const initialContactFormFields =
    createOrEdit === "CREATE"
      ? [
          [
  ...
  const [lastContactFormElement, setLastContactFormElement] = useState(
    contactFormElements.length
  );
            ...
            <fieldset>
              <legend style={{ width: "100%", position: "relative" }}>
                ...
                <Button
                  onClick={getPosition}
                  style={{ position: "absolute", right: "0px", bottom: "8px" }}
                  icon={<EnvironmentOutlined translate="true" />}
                >
