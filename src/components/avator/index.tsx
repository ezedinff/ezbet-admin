...
export class Avatar extends React.Component<{handleUpload: Function}, {imageUrl: string, loading: Boolean}> {
  state = {
    imageUrl: '',
    loading: false,
  };
  ...
  render() {
    ...
    return (
      <Upload
        ...
        style={{minWidth: "300px", maxWidth: "300px", minHeight: "200px", maxHeight: "200px"}}
